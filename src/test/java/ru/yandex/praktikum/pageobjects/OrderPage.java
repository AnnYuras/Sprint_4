...
public class OrderPage {
    ...
    private final By metroList = By.className("select-search");

    //Список доступных для выбора станций метро */
    private final By metroListItems = By.xpath(".//div[@class='select-search has-focus']//div[starts-with(@class,'Order_Text')]");
    ...
    private final By termDropdownRoot = By.xpath(".//div[@class = 'Dropdown-root']");

    //Список доступных для выбора дней аренды */
